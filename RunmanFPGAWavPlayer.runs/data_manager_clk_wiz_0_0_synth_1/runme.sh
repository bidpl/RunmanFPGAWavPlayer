...
HD_PWD='C:/Users/ramseyv2/repos/RunmanFPGAWavPlayer/RunmanFPGAWavPlayer.runs/data_manager_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log data_manager_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source data_manager_clk_wiz_0_0.tcl
